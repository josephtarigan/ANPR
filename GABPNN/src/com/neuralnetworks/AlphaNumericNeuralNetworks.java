...
public class AlphaNumericNeuralNetworks implements INeuralNetworksTrainable{
	...
	private int hiddenLayerNeuronCount = 188; //default
	private int outputLayerNeuronCount = 36;
	private int numberOfLayer = 3;
	private int[] numberOfNeuron = new int[numberOfLayer];
	private final String[] layerNames = {"inputLayer", "hiddenLayer", "outputLayer"};
	private double momentumRate = 0.6640625;
	private double learningRate = 0.140625;
	/*
	 * Alphanumeric object
	...
	public void init(){
		...
		numberOfNeuron[0] = firstLayerNeuronCount;
		numberOfNeuron[1] = hiddenLayerNeuronCount;
		numberOfNeuron[2] = outputLayerNeuronCount;
	...
	/*
	 * Set the number of hidden neuron
	 * for GA use
	 */
	public void setHiddenNeuronCount(int hiddenNeuron){
		
		this.hiddenLayerNeuronCount = hiddenNeuron;
	}
	...
	public int getHiddenNeuronCount(){
		...
		return this.hiddenLayerNeuronCount;
	}
